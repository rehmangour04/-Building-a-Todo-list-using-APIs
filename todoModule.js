...
//IIFE Module Design Pattern & JavaScript Revealing Module Pattern
let TodoListApp = (function () {
  ...
  // initializeApp(); Now we are not initializing the app directly, instead initializing form outside

  //In the return, we can pass the data, which we want to be accessible by other js files
  return {
